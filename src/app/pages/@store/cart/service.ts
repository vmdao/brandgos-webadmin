...
export class CartService {
  ...
  getPaymentItemDetailAffiliate(
    paymentId: number
  ): Observable<CartResultModel> {
  ...
  removeSim(key, sim): Observable<CartResultModel> {
    const value = { simId: sim.simId };
    return this.restService.post(`/affiliate/cart/${key}/remove-sim`, value);
  }
